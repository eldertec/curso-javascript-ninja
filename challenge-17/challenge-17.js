...
console.log(text.replace(/Manuel Marques de Sousa/, 'Élder Rezende'));
...
console.log(text.replace(/brasileiro/, 'goiano'));
...
//OU
console.log(text.replace(/[D-Z]|[a-h]/g,0));//OU console.log(text.replace(/[D-Za-h]/g,0));
